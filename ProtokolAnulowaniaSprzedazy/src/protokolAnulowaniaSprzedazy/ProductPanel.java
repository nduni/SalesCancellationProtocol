	...
	public ProductPanel() {
		...
		textField_03 = new JTextField();
		  ...
		  @Override public void keyPressed(KeyEvent arg0) {
		           ...
		           if (hasDouble(textField_04) && hasDouble(textField_03)) { double d
		           = multiplication(textField_03, textField_04);
		           textField_05.setText(String.valueOf(d));
		           textField_06.setText("23");
		           textField_08.setText(BigDecimal.valueOf(d / 1.23).setScale(2,
		           BigDecimal.ROUND_HALF_UP).toString()); textField_07
		           .setText(BigDecimal.valueOf(d - d / 1.23).setScale(2,
		            BigDecimal.ROUND_HALF_UP).toString()); } else {
		            textField_05.setText(""); textField_07.setText("");
