	...
	private void initialize() {
		...
		textField_13.addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(KeyEvent arg0) {
				...
				if (hasDouble(textField_14) && hasDouble(textField_13)) {
					double d = multiplication(textField_13, textField_14);
					textField_15.setText(String.valueOf(d));
					textField_16.setText("23");
					textField_18.setText(BigDecimal.valueOf(d / 1.23).setScale(2, BigDecimal.ROUND_HALF_UP).toString());
					textField_17
							.setText(BigDecimal.valueOf(d - d / 1.23).setScale(2, BigDecimal.ROUND_HALF_UP).toString());
				}
				else {
		...
		txtpnNazwaProduktu.setBounds(33, 39, 108, 31);
